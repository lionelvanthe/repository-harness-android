...
```bash
curl -fsSL "https://raw.githubusercontent.com/lionelvanthe/repository-harness-android/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --yes
```

On Windows PowerShell, run:

```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/lionelvanthe/repository-harness-android/main/scripts/install-harness.ps1"))) -Yes
```
...
curl -fsSL "https://raw.githubusercontent.com/lionelvanthe/repository-harness-android/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --merge --yes

# Back up and replace AGENTS.md, docs/, and scripts/
curl -fsSL "https://raw.githubusercontent.com/lionelvanthe/repository-harness-android/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --override --yes
```

```powershell
# Update an existing Harness repo without moving existing files
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/lionelvanthe/repository-harness-android/main/scripts/install-harness.ps1"))) -Merge -Yes

# Back up and replace AGENTS.md, docs/, and scripts/
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/lionelvanthe/repository-harness-android/main/scripts/install-harness.ps1"))) -Override -Yes
```
...
```bash
curl -fsSL "https://raw.githubusercontent.com/lionelvanthe/repository-harness-android/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --merge --refresh-agent-shim --yes
```
...
```bash
curl -fsSL "https://raw.githubusercontent.com/lionelvanthe/repository-harness-android/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --claude --yes
```

Or install into a specific path:

```bash
curl -fsSL "https://raw.githubusercontent.com/lionelvanthe/repository-harness-android/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --directory /path/to/project --yes
```

```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/lionelvanthe/repository-harness-android/main/scripts/install-harness.ps1"))) -Directory C:\path\to\project -Yes
```
